...
from api.routes.activity_trends import router as activity_trends_router
...
from api.routes.pipeline_health import router as pipeline_health_router
...
api_router.include_router(activity_trends_router)
...
api_router.include_router(pipeline_health_router)
